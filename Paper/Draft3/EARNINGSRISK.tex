...
\begin{figure}[H]
    \centering
    \caption{Mean Ensemble-Predicted Gamma and Alpha (NN, RF, LASSO) by Age Across Cohorts. Solid = born pre-1944; Dashed = 1944--1952; Dotted = 1953--1960; Dash-dot = post-1960.}
    \label{fig:mean_pred_risk_by_age_cohort}
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Gamma, Hourly Wage}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_gam_wage_pred_by_age_cohort.png}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Alpha, Hourly Wage}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_alph_wage_pred_by_age_cohort.png}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Gamma, Annual Earnings}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_gam_earn_pred_by_age_cohort.png}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Alpha, Annual Earnings}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_alph_earn_pred_by_age_cohort.png}
    \end{minipage}
\end{figure}
...
\begin{table}[H]
    \centering
    \caption{Mean Ensemble-Predicted Gamma in the Top and Bottom Predicted-Risk Deciles by Age, Annual Earnings (x 100)}
...
\begin{table}[H]
    \centering
    \caption{Mean Ensemble-Predicted Alpha in the Top and Bottom Predicted-Risk Deciles by Age, Annual Earnings (x 100)}
