...
\begin{table}[H]
    \centering
    \caption{Stepwise Selection of Growth-Regression Controls by Horizon Bin}
    \label{tab:growth_sel_stepwise}
    \input{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/3.2_stepwise_selection.tex}
\end{table}

\begin{table}[H]
    \centering
    \caption{LASSO Selection of Growth-Regression Controls by Horizon Bin}
    \label{tab:growth_sel_lasso}
    \input{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/3.2_lasso_selection.tex}
\end{table}

\begin{table}[H]
    \centering
    \caption{F-Tests of Growth-Regression Control Sets by Horizon Bin}
    \label{tab:growth_sel_ftest}
    \resizebox{\textwidth}{!}{%
        \input{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/3.2_ftest.tex}
    }
\end{table}

\begin{table}[H]
    \centering
    \caption{LASSO Selection for Raw-Difference Gamma and Alpha}
    \label{tab:gamalpha_sel_lasso}
    \input{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/3.2_gamalpha_lasso_selection.tex}
\end{table}

\begin{table}[H]
    \centering
    \caption{F-Tests of Control Sets for Raw-Difference Gamma and Alpha}
    \label{tab:gamalpha_sel_ftest}
    \resizebox{\textwidth}{!}{%
        \input{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/3.2_gamalpha_ftest.tex}
    }
\end{table}
...
\begin{figure}[H]
    \centering
    \caption{Mean Gamma and Alpha by Age Across Cohorts. Solid = born pre-1944; Dashed = 1944--1952; Dotted = 1953--1960; Dash-dot = post-1960.}
    \label{fig:mean_risk_by_age_cohort}
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Gamma, Hourly Wage}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_gam_wage_by_age_cohort.png}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Alpha, Hourly Wage}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_alph_wage_by_age_cohort.png}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Gamma, Annual Earnings}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_gam_earn_by_age_cohort.png}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \textbf{Alpha, Annual Earnings}\\[4pt]
        \includegraphics[width=\linewidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/mean_alph_earn_by_age_cohort.png}
    \end{minipage}
\end{figure}
...
\begin{table}[H]
    \centering
    \caption{Distribution of the OLS-Predicted Gamma and Alpha (x 100)}
    \label{tab:ols_pred_summary_stats}
    \input{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/ThirdDraft/ols_pred_summary_stats.tex}
\end{table}
...
\begin{table}[H]
    \centering
    \caption{Characteristics of Top and Bottom Risk Deciles by Age, Gamma (Sorted by Raw Risk; Percent Shares)}
...
\begin{table}[H]
    \centering
    \caption{Characteristics of Top and Bottom Risk Deciles by Age, Alpha (Sorted by Ensemble-Predicted and Raw Risk; Percent Shares)}
