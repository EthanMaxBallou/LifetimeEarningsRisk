...
Table 1 shows the OLS estimates of gamma using the different specifications. 

- The coeffiecnts are quite small. However the gamma is centered very tigthly around 0
- The only coefficents are that are signifcant are EDU1, EDU2, currentage, currentagesq, and currentagecube.
- EDU1 and EDU2 are only somewhat significant, EDU2 being more significant with insutry controls
- Education as a trend at least is negative in all cases. 
- Age is positive and signiicant while the squared term is negative and more significant.
