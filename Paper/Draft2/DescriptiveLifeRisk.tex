...
\begin{enumerate}
    ...
    \item Do cross validation for RF and lasso?
\end{enumerate}
...
\begin{figure}[H]
    ...
    \caption{Gamma Industry SHAP Rank Comparisons}
...
\begin{figure}[H]
    ...
    \caption{Gamma Occupation SHAP Rank Comparisons}
...
\begin{table}[H]
    \centering
    \caption{Gamma Regressions: OLS Results (Coefficients x 100)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/gamma_age_margins.pdf}
    \caption{Predicted Gamma by Age (No Controls)}
    \label{fig:gamma_age_margins}
\end{figure}
...
\begin{table}[H]
    \centering
    \caption{Gamma Regressions: Stepwise Selection Results (Coefficients x 100)}
...
\begin{figure}[H]
    ...
    \caption{Alpha Industry SHAP Rank Comparisons}
...
\begin{figure}[H]
    ...
    \caption{Alpha Occupation SHAP Rank Comparisons}
...
\begin{table}[H]
    \centering
    \caption{Alpha Regressions: OLS Results (Coefficients x 100)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/OtherOutput/alpha_age_margins.pdf}
    \caption{Predicted Alpha by Age (No Controls)}
    \label{fig:alpha_age_margins}
\end{figure}
...
\begin{table}[H]
    \centering
    \caption{Alpha Regressions: Stepwise Selection Results (Coefficients x 100)}
