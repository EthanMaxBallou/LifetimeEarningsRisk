...
nn1 = tf.keras.models.load_model("/Users/ethanballou/Documents/Github/LifetimeEarningsRisk/Risk_NN_Gamma_fearn.keras")
...
shap_summary_df.to_csv('/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/shap_summary_gamma_fearn.csv', index=False)
...
shap.summary_plot(shap_values_top_cont, X_test_top_cont, feature_names=top_cont, max_display=len(top_cont), show=False)
plt.tight_layout()
plt.savefig('/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/GAMMA_shap_summary_plot_fearn.png', bbox_inches='tight', dpi=300)
plt.close()
...
# Define the input and output file paths
input_file = '/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk/shap_summary_gamma_fearn.csv'
output_dir = '/Users/ethanballou/Documents/GitHub/LifetimeEarningsRisk'
occupation_output = os.path.join(output_dir, 'occupation_shap_gamma_fearn.csv')
industry_output = os.path.join(output_dir, 'industry_shap_gamma_fearn.csv')
