...
rf1 = RandomForestRegressor(
    ...
    max_depth=16,          # let trees grow fully (can tune this)
...
shap_summary_df.to_csv(os.path.join(SHAPDIR, 'RF_shap_summary_alpha.csv'), index=False)
...
input_file = os.path.join(SHAPDIR, 'RF_shap_summary_alpha.csv')
output_dir = SHAPDIR
...
shap_summary_df.to_csv(os.path.join(SHAPDIR, 'RF_shap_summary_gamma.csv'), index=False)
...
# Define the input and output file paths
input_file = os.path.join(SHAPDIR, 'RF_shap_summary_gamma.csv')
output_dir = SHAPDIR
...
shap_summary_df.to_csv(os.path.join(SHAPDIR, 'RF_shap_summary_alpha_fearn.csv'), index=False)
...
# Define the input and output file paths
input_file = os.path.join(SHAPDIR, 'RF_shap_summary_alpha_fearn.csv')
output_dir = SHAPDIR
occupation_output = os.path.join(output_dir, 'RF_occupation_shap_alpha_fearn.csv')
industry_output = os.path.join(output_dir, 'RF_industry_shap_alpha_fearn.csv')
...
shap_summary_df.to_csv(os.path.join(SHAPDIR, 'RF_shap_summary_gamma_fearn.csv'), index=False)
...
# Define the input and output file paths
input_file = os.path.join(SHAPDIR, 'RF_shap_summary_gamma_fearn.csv')
output_dir = SHAPDIR
occupation_output = os.path.join(output_dir, 'RF_occupation_shap_gamma_fearn.csv')
industry_output = os.path.join(output_dir, 'RF_industry_shap_gamma_fearn.csv')
