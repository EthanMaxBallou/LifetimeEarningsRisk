...
nn1 = tf.keras.models.load_model(os.path.join(MODELDIR, "Risk_NN_Gamma.keras"))
...
shap_summary_df.to_csv(os.path.join(SHAPDIR, 'shap_summary_gamma.csv'), index=False)
...
input_file = os.path.join(SHAPDIR, 'shap_summary_gamma.csv')
output_dir = SHAPDIR
...
nn1 = tf.keras.models.load_model(os.path.join(MODELDIR, "Risk_NN_Gamma_fearn.keras"))
...
shap_summary_df.to_csv(os.path.join(SHAPDIR, 'shap_summary_gamma_fearn.csv'), index=False)
...
# Define the input and output file paths
input_file = os.path.join(SHAPDIR, 'shap_summary_gamma_fearn.csv')
output_dir = SHAPDIR
